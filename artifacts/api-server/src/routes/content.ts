...
const seedContent = [
  ...
  },
  {
    ...
    description: "The plain power loom is the workhorse of the weaving section, producing plain-weave fabric at scale with reliable, consistent output. It handles straightforward weave structures efficiently across long production runs.",
    category: "Weaving",
    image: heroImage,
  ...
  },
  {
    ...
    description: "The dobby power loom adds pattern capability to the weaving floor. It lifts individual warp threads to create webbed, textured and dobby woven designs with more complexity than a plain loom.",
  ...
  },
  {
    ...
    description: "The water jet loom uses a high-pressure water jet to carry the weft yarn across the warp, producing smooth, dense fabric at very high speed. It suits fine and synthetic yarns with a clean, even finish.",
    category: "Weaving",
    image: heroImage,
    images: [heroImage, fabricImage],
    published: true,
  ...
  },
  {
    ...
    description: "The press and repair section handles finishing and maintenance across the production floor. These machines press woven fabric to a clean finish and support in-house repair work that keeps production moving.",
    category: "Finishing",
    image: fabricImage,
    images: [fabricImage, heroImage],
    published: true,
