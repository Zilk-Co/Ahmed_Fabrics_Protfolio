...
const seedContent = [
  ...
  },
  {
    ...
    slug: "plain-power-loom",
    title: "Plain Power Loom",
    shortDescription: "A dependable plain-weave loom for high-volume fabric production.",
    description: "The plain power loom is the workhorse of the weaving section, producing plain-weave fabric at scale with reliable, consistent output. It handles straightforward weave structures efficiently across long production runs, making it the foundation for base fabrics used in garments, home textiles, linings and industrial applications. Each loom can be adjusted for different thread counts and densities to match specific customer requirements.",
    category: "Weaving",
    image: heroImage,
    images: [heroImage, fabricImage],
    published: true,
    featured: true,
    displayOrder: 1,
    meta: { application: "High-volume production of plain-weave fabric for garments, home textiles and lining cloth." },
  },
  {
    collection: "machinery",
    slug: "dobby-power-loom",
    title: "Dobby Power Loom",
    shortDescription: "A versatile loom for patterned, webbed and dobby designs.",
    description: "The dobby power loom adds pattern capability to the weaving floor. It lifts individual warp threads to create webbed, textured and dobby woven designs with more complexity than a plain loom. Using a dobby mechanism, it can produce small geometric patterns, checks, stripes and textured weaves that are difficult to achieve on standard looms. This makes it essential for producing decorative fabrics, shirting materials and technical textiles with structured surface patterns.",
    category: "Design / Weaving",
    image: fabricImage,
    images: [fabricImage, heroImage],
    published: true,
    featured: true,
    displayOrder: 2,
    meta: { application: "Weaving webbed, dobby and patterned fabric for decorative and technical textile applications." },
  },
  {
    collection: "machinery",
    slug: "water-jet-loom",
    title: "Water Jet Loom",
    shortDescription: "A high-speed loom using water jets for dense, fine fabric.",
    description: "The water jet loom uses a high-pressure water jet to carry the weft yarn across the warp, producing smooth, dense fabric at very high speed. It suits fine and synthetic yarns with a clean, even finish, and is particularly effective for polyester, nylon and blended fabrics. The water-jet method reduces friction and static, resulting in a softer hand-feel and more uniform surface compared to traditional mechanical insertion looms.",
    category: "Weaving",
    image: heroImage,
    images: [heroImage, fabricImage],
    published: true,
    featured: true,
    displayOrder: 3,
    meta: { application: "High-speed weaving of fine, dense and synthetic fabrics for apparel and technical uses." },
  },
  {
    collection: "machinery",
    slug: "press-and-repair-machines",
    title: "Press & Repair Machines",
    shortDescription: "Machinery for pressing, finishing and repair work on the floor.",
    description: "The press and repair section handles finishing and maintenance across the production floor. These machines press woven fabric to a clean, smooth finish and support in-house repair work that keeps production moving without downtime. Press machines apply controlled heat and pressure to remove wrinkles, set the fabric shape and improve surface appearance. The repair section maintains looms, replaces worn parts and ensures every machine on the floor runs at full capacity throughout production cycles.",
    category: "Finishing",
    image: fabricImage,
    images: [fabricImage, heroImage],
    published: true,
    featured: true,
    displayOrder: 4,
    meta: { application: "Pressing and finishing fabric, plus repair and maintenance support across the factory floor." },
  },
  {
    collection: "machinery",
    slug: "warping-machine",
    title: "Warping Machine",
    shortDescription: "Prepares warp yarns ready for the weaving process.",
    description: "The warping machine winds warp yarns from cones onto a beam in carefully controlled tension, preparing them for the looms. Accurate warping improves weaving quality and reduces wastage.",
    ...
    featured: false,
    displayOrder: 5,
    meta: { application: "Preparing warp beams for the weaving section." },
  },
  {
    collection: "machinery",
    slug: "sizing-machine",
    title: "Sizing Machine",
    shortDescription: "Coats warp yarns for strength before weaving.",
    description: "The sizing machine applies a protective coating to warp yarns, giving them the strength and smoothness needed to withstand the stresses of weaving.",
    category: "Preparation",
    image: fabricImage,
    images: [fabricImage],
    published: true,
    featured: false,
    displayOrder: 6,
    meta: { application: "Strengthening warp yarns before weaving." },
  },
  {
    collection: "machinery",
    slug: "dyeing-unit",
    title: "Dyeing Unit",
    shortDescription: "Adds consistent colour to woven fabric.",
    description: "The dyeing unit applies colour to fabric in controlled batches, supporting the factory's range of dyed textiles with even, repeatable results.",
    category: "Processing",
    image: heroImage,
    images: [heroImage],
    published: true,
    featured: false,
    displayOrder: 7,
    meta: { application: "Batch dyeing of fabric to consistent colour." },
  },
  {
    collection: "machinery",
    slug: "finishing-calender",
    title: "Finishing Calender",
    shortDescription: "Smooths and compacts fabric for a clean finish.",
    description: "The finishing calender passes fabric between rollers to smooth, compact and give it a polished surface finish before dispatch.",
    category: "Finishing",
    image: fabricImage,
    images: [fabricImage],
    published: true,
...
const sampleItems = [
  ...
  { collection: "machinery", slug: "sample-weaving-loom", title: "Power Loom Section", shortDescription: "The main weaving section with multiple power looms in operation.", description: "Power looms form the core of the weaving section, producing fabric at scale for a range of textile applications. Each loom can be configured for different weave patterns and thread densities.", category: "Weaving", image: heroImage, images: [heroImage], published: true, featured: false, displayOrder: 10, meta: { application: "General weaving of a range of textile fabric." } },
